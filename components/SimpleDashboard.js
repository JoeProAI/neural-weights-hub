        ...
        {activeTab === 'sandbox' && (
          <div className="space-y-8">
            <div className="bg-gray-800 rounded-lg p-6">
              ...
              <p className="text-gray-400 mb-6">Create and manage your development sandboxes</p>
              
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <button
                    onClick={() => testAPI('/sandbox/connect', 'POST')}
                    disabled={loading}
                    className="bg-blue-600 hover:bg-blue-700 disabled:bg-gray-600 px-6 py-3 rounded font-semibold"
                  >
                    {loading ? 'Connecting...' : 'Open My Sandbox'}
                  </button>
                  
                  <button
                    onClick={() => testAPI('/sandbox/create', 'POST', { 
                      name: `sandbox-${Date.now()}`,
                      language: 'python',
                      plan: 'free' // TODO: Get from user profile
                    })}
                    disabled={loading}
                ...
                <button
                  ...
                  disabled={loading}
                  className="w-full bg-red-600 hover:bg-red-700 disabled:bg-gray-600 px-6 py-2 rounded font-medium"
                >
